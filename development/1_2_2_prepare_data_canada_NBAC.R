...
dir_obs <- "~/Documents/dati/fire_climate_data/fire/fire_canada/nbac_1986_to_2020_20210810/"
...
ncatt_put(
  ...
  0,
  "Title",
  'An integrated dataset of observed national inventories of fires - CANADA NBAC'
)
